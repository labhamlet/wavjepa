...
#SBATCH --output=eval_red/slurm_output_%A_%a.out
#SBATCH --array=0-10
...
embeddings_dir=/projects/0/prjs1338/EmbeddingsJEPAReduced1_0
score_dir=nathear_wavjepa_1.0

model_name=hear_configs.SJEPA_nat
sr=16000
model_size=base
weights=/gpfs/work4/0/prjs1338/saved_models_jepa_naturalistic_mix/InChannels=2/WithNoise=True/WithRIR=True/CleanRatio=1.0/Extractor=spatial-conv-channel-extractor/ShareWeights=False/SR=16000/BatchSize=16/NrSamples=8/NrGPUs=2/ModelSize=base/LR=0.0004/Masking=time-inverse-masker/TargetProb=0.25/TargetLen=10/ContextLen=10/TopK=8/step=375000.ckpt
