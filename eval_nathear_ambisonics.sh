...
#SBATCH --output=eval/slurm_output_%A_%a.out
#SBATCH --array=0-10
...
embeddings_dir=/projects/0/prjs1338/EmbeddingsJEPAReduced
score_dir=nathear_wavjepa_reduced

model_name=hear_configs.SJEPA_nat
sr=16000
model_size=base
weights=/gpfs/work5/0/prjs1261/save_model_jepa_final_from_naturalistic_mixing/InChannels=2/WithNoise=True/WithRIR=True/CleanRatio=0.0/Extractor=spatial-conv-channel-extractor/ShareWeights=False/SR=16000/BatchSize=16/NrSamples=8/NrGPUs=2/ModelSize=base/Masking=time-inverse-masker/MaskProb=0.065/MaskLen=None/Cluster=None/TopK=8/last.ckpt
