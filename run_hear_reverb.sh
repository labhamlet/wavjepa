...
#SBATCH --output=hear_reverb/slurm_output_%A_%a.out
#SBATCH --array=0
...
tasks_dir=/projects/prjs1338/create_reverb_hear/outputs

embeddings_dir="/projects/prjs1338/JepaEmbeddingsReverb"
score_dir="reverb_hear_wavjepa"
